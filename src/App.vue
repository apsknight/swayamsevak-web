            ...
            <tr>
                <td>
                    ...
                    <div v-for="r in a.result.fulfillment.messages">
                        ...
                        <!-- Broadcast message types / Card -->
                         <div class="mdc-card" v-if="r.type == 'broadcast_card'">
                            <section class="mdc-card__primary">
                                <h1 class="mdc-card__title">
                                    📢 Broadcast
                                </h1>
...
export default {
    ...
    methods: {
        ...
        broadcast() {
            ...
            client.textRequest('broadcast').then((response) => {
                console.log('Broadcast response fetched');
